...
this.tocContent+="<ul style='padding:10px' >";}}else{this.tocContent+="</li>";}}else{if(this._tempLists.length){this.tocContent+=new Array(this._tempLists.length+1).join("</li></ul>");
}else{this.tocContent+="</li>";}}}this.tocContent="<ul style='padding:10px'>"+this.tocContent+"</ul>";};a.prototype._showToc=function(){this.toc=document.createElement("div");
...
}var c=this;if(this.tocTop>-1){b.onscroll=function(){var d=document.documentElement.scrollTop||document.body.scrollTop;if(d<c.tocTop){c.toc.setAttribute("style","background:#fff;position:relative;");
}else{c.toc.setAttribute("style","z-index:9;overflow:hidden;background: #fff;border: 1px solid #eee;border-radius: 4px;padding: 15px 20px 18px;margin-bottom: 10px;;position:fixed;top:10px;");c.toc.setAttribute("id","toclist");}};}};b.Toc=a;})(window);